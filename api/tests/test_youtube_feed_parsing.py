...
from app.youtube_parsing import YouTubeService, Video
...
class TestFetchVideosFromRssFeed(unittest.TestCase):
    def test_fetch_videos_from_rss_feed(self) -> None:
        result: list[Video] = YouTubeService.fetch_videos_from_rss_feed(
            "http://test.com", request_maker=mock_make_request
        )
